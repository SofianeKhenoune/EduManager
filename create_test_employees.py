...
headers = [
    ...
    "Salaire horaire", "Salaire mensuel Brut", "Navigo", "Taux PAS", "Matricule"
]

ws.append(headers)

# Données de test avec matricules uniques à 5 chiffres
test_employees = [
    [
